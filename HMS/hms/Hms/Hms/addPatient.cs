...
namespace Hms
{
    public partial class addPatient : Form
    {
        ...
        {
            string patientName, patientDisease, patientBlood, patientCnic, patientGender, patientAddress,patientMobile;
            ...
            if (obj != null)
            {
                DialogResult result = MessageBox.Show("Patient added Successfully", "Message", MessageBoxButtons.OKCancel);
